...
public abstract class BaseExperimentSharedData {

    protected SharedData sharedData;

    public abstract SharedData buildSharedData();
    ...
    @State(Scope.Benchmark)
    public abstract static class SimpleBenchmarks extends BaseExperimentSharedData {

        @Benchmark
        @Threads(Threads.MAX)
        public void multithreadRead(Blackhole blackhole) {
            blackhole.consume(sharedData.read());
        }

        @Benchmark
        @Threads(Threads.MAX)
        public void multithreadWrite(Blackhole blackhole) {
            blackhole.consume(sharedData.write());
        }
    ...
    @State(Scope.Group)
    public abstract static class GroupedBenchmarks extends BaseExperimentSharedData {
